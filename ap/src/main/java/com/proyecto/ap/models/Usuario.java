package com.proyecto.ap.models;
...
public class Usuario implements Serializable {
    ...
    public Usuario(Long id, String nombre, String titulo, String descripcion, String fotoPerfil, String banner, String github, String linkedIn) {
        this.id = id;
        this.nombre = nombre;
        this.titulo = titulo;
